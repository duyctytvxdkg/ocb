GO
/****** Object:  UserDefinedFunction [dbo].[TCVN2Unicode]    Script Date: 1/7/2019 8:59:24 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER FUNCTION [dbo].[TCVN2Unicode] (@strInput VARCHAR(4000)) RETURNS NVARCHAR(4000)
AS
BEGIN
